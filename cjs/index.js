...
var ReactLaravelPagin = function ReactLaravelPagin(props) {
  ...
  if (!baseLink || baseLink.trim().length < 1) return /*#__PURE__*/React__default["default"].createElement("div", null);
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", null, links.map(function (_ref2) {
    var url = _ref2.url,
        label = _ref2.label,
        active = _ref2.active;
    if (customDots && label === "...") return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, customDots());
    if (customPrev && label === "&laquo; Previous") return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, customPrev({
    ...
    if (customNext && label === "Next &raquo;") return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, customNext({
      onClick: function onClick() {
        if (url) {
          setUrl(url);
        }
    ...
    return /*#__PURE__*/React__default["default"].createElement(PageLink, {
      key: label,
      label: label,
      url: url,
      active: active,
